...
public:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?PrepareForRemoteReference@BamoProxyImpl@BamoImpl@Microsoft@@QEAAIPEAVBamoPrincipal@Bamo@3@@Z
    ...
    // Symbol: ??1BamoProxyImpl@BamoImpl@Microsoft@@UEAA@XZ
    virtual ~BamoProxyImpl();
private:
    // Category: Method | Source: PDB Internal
