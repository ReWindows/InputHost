...
static constexpr wchar_t module_name[14] = {0x0049, 0x006E, 0x0070, 0x0075, 0x0074, 0x0048, 0x006F, 0x0073, 0x0074, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 41609020U || rva >= image_size) return nullptr;
return base + rva;
}
