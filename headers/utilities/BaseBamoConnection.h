...
public:
    ...
    // Symbol: ?AddRef@BaseBamoConnection@Bamo@Microsoft@@QEAAKXZ
    unsigned long AddRef();
    // Category: Accessor | Source: PDB Internal
    // Symbol: ?GetSession@BaseBamoConnection@Bamo@Microsoft@@QEBAPEAUIMessageSession@@XZ
    IMessageSession * GetSession() const;
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?VerifyLockHeldIfOffThread@BaseBamoConnection@Bamo@Microsoft@@QEBAXXZ
