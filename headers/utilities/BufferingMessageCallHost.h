...
public:
    ...
    // Symbol: ?AddPrincipalParameter@BufferingMessageCallHost@BamoImpl@Microsoft@@QEAAXPEAVBamoPrincipal@Bamo@3@@Z
    void AddPrincipalParameter(::Microsoft::Bamo::BamoPrincipal *);
