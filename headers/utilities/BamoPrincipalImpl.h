...
public:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?PrepareForRemoteReference@BamoPrincipalImpl@BamoImpl@Microsoft@@SAIPEAVBamoPrincipal@Bamo@3@PEAVBaseBamoPeer@53@@Z
    static unsigned int PrepareForRemoteReference(::Microsoft::Bamo::BamoPrincipal *, ::Microsoft::Bamo::BaseBamoPeer *);
