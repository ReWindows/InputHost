//! Windissect-generated Rust FFI bindings for InputHost.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "ABCDD08862C83DBF2EE2F171207BBB2F";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 41609020;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 14] = [73, 110, 112, 117, 116, 72, 111, 115, 116, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 41609020 { return 0; }
